...
class CatTabBarController:UITabBarController {
    ...
    private func setupTabBarController() {
        ...
        catCurrentStatus.tabBarItem = UITabBarItem(title: "提醒", image: UIImage(systemName: "alarm.waves.left.and.right"), tag: 1)
        reminderNavController.tabBarItem = UITabBarItem(title: "设置", image: UIImage(systemName: "gear"), tag: 0)
        catProfile.tabBarItem = UITabBarItem(title: "个人", image: UIImage(systemName: "person.crop.circle"), tag: 2)
        viewControllers = [reminderNavController, catCurrentStatus, catProfile]
    }
